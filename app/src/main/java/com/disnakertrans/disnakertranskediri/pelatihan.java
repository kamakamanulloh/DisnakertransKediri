...
public class pelatihan extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    private void showEmployee(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                pelatihan.this, list, R.layout.list_pengumuman,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(pelatihan.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(konfigurasi.URL_pelatihan);
                return s;
            }
        }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(pelatihan.this, home.class);
